          ...
          <div>
            <div className="relative">
              <input
                ...
                autoCorrect="off"
                spellCheck={false}
                className={`w-full rounded-md border pr-10 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 ${errors.password ? "border-red-400" : "border-gray-300 bg-white"}`}
              />
              <button
                type="button"
